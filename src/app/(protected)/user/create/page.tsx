...
const validateForm = () => {
  ...
  // ❌ Removed supervisor required check
                ...
                <SelectContent>
                  {regions
                    .filter(r => {
                      ...
                      return !formData.company_id || rCompanyId === String(formData.company_id);
                    })
                    .map(r => (
  ...
  {users
    .filter(u => {
      ...
      const sameVendor =
        ...
        console.log('Form Data Company', formData.company_id);
console.log('User Company', userCompanyId);
console.log('Form Data Vendor', formData.vendor_id);
console.log('User Vendor', userVendorId);
